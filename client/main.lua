...
Citizen.CreateThread(function()
    while true do
     ...
     if not IsPedInAnyVehicle(PlayerPedId(), false) then
      ...
      -- Exiting
      local aiming, targetPed = GetEntityPlayerIsFreeAimingAt(PlayerPedId())
      if aiming then
            ...
            if closestPed ~= nil then
                ...
                if IsPedInAnyVehicle(PlayerPedId()) then
                    ...
                    if QBCore.Shared.Vehicles[modelName] ~= nil then
                        Name = QBCore.Shared.Vehicles[QBCore.Shared.Vehicles[modelName]["model"]]["brand"] .. ' ' .. QBCore.Shared.Vehicles[QBCore.Shared.Vehicles[modelName]["model"]]["name"]
                    else
                        Name = "Unknown"
                    end
